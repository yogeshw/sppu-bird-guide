...
\introsection{%
  \section*{Optimal Observation Periods}
  The study of campus avifauna requires methodical attention to both diurnal and seasonal rhythms, each presenting distinct opportunities for observation and behavioral study.

  \textbf{Diurnal Rhythm:}
  \begin{itemize}
  \item Dawn to Early Morning (0600-0900 hrs): This period proves invariably the most rewarding for systematic observation. The dawn chorus, initiated typically by the Magpie Robin and Red-vented Bulbul, heralds a burst of activity as diurnal species emerge from their roosts. Particular attention should be paid to the sequence of awakening, which follows a remarkably consistent pattern
  
  \item Late Morning (0900-1100 hrs): As the day warms, attention should turn skyward. This period is optimal for studying the hunting behavior of resident raptors, particularly the Black Kite and Shikra, as they utilize the developing thermals. The various swifts and swallows, too, are notably active at this hour
  
  \item Midday (1100-1500 hrs): Though general activity diminishes, this period offers excellent opportunities for studying certain specific behaviors. The communal bathing of babblers and bulbuls, the hunting techniques of drongos, and the roosting habits of owls merit particular attention
  
  \item Late Afternoon (1500-1830 hrs): A second peak of avian activity commences as the day cools. This period is especially profitable for observing mixed-species feeding associations and the formation of pre-roosting assemblages. The calls and displays of barbets and cuckoos reach their evening crescendo during this time
  
  \item Dusk (1830-1930 hrs): A fascinating period of transition when diurnal species retire and nocturnal birds, particularly the Spotted Owlet and Mottled Wood Owl, begin their activities. The roosting assemblies of mynas and parakeets provide instructive studies in social behavior
  \end{itemize}

  \textbf{Seasonal Fluctuations:}
  \begin{itemize}
  \item Winter (November-February): The cold weather brings a remarkable enrichment of the campus avifauna. The arrival of winter visitors, notably the Grey Wagtail, Lesser Whitethroat, and various flycatchers, provides opportunities for studying migration patterns and habitat utilization. The resident birds, too, show interesting behavioral adaptations to the cooler temperatures
...
\introsection{%
  \section*{Field Equipment and Methodology}
  The study of birds, while immensely rewarding, demands careful attention to both equipment and technique. The following recommendations stem from extensive field experience:

  \textbf{Essential Equipment:}
  \begin{itemize}
  \item Binoculars: While various optical instruments are available, a pair of 8x40 or 10x42 binoculars proves most efficacious for general observation. The 8x40 configuration is particularly advantageous for following birds in flight, offering an optimal balance between magnification and field of view. The slightly higher magnification of 10x42 glasses may be preferred for detailed plumage studies, though at some cost to brightness and field width
  
  \item Field Guide: Among the numerous guides available, Grimmett, Inskipp \& Inskipp's \textit{Birds of the Indian Subcontinent} stands preeminent for its comprehensive treatment and accurate illustrations. One should, however, supplement this with regional works for local variations and behavioral notes
  
  \item Field Notebook: The importance of maintaining detailed field notes cannot be overemphasized. One's notebook should record not merely species identification but also behavioral observations, ecological associations, and environmental conditions. These contemporaneous notes, however rough, invariably prove more reliable than memory
  \end{itemize}

  \textbf{Modern Aids:}
  While traditional methods retain their primacy, certain modern tools merit judicious incorporation:
  \begin{itemize}
  \item eBird: This digital platform has revolutionized the collection and analysis of bird distribution data. Its standardized protocols facilitate the meaningful comparison of observations across time and space
  
  \item Merlin Bird ID: Though no substitute for field experience, this application proves particularly valuable for beginners in narrowing down identification possibilities
...
\introsection{%
  ...
  This guide endeavours to present a systematic account of the more frequently encountered avian species within the University campus. While not aspiring to complete comprehensiveness, it includes detailed treatments of those birds that the regular observer might reasonably expect to encounter during the course of a year's observations.

  Each species account synthesizes field identification features with notes on behavior, habitat preferences, and breeding biology where known. The accompanying photographs have been selected primarily for their diagnostic value rather than mere aesthetic appeal. The nomenclature adheres to current taxonomic understanding, though one must note that this remains subject to periodic revision as our knowledge advances.

  The digital version of this documentation, maintained at \href{http://github.com/yogeshw/sppu-bird-guide}{http://github.com/yogeshw/sppu-bird-guide}, welcomes scholarly contributions and corrections. The dynamic nature of this format allows for regular updates as new observations come to light or taxonomic revisions necessitate changes.

  It is hoped that this guide will not merely facilitate identification but also stimulate systematic observation and documentation of the campus avifauna, thereby contributing to our understanding of urban bird ecology in the Western Ghats region.
}
