...
% Helper command to convert spaces and capitals to dashes and lowercase
\usepackage{xstring}
\newcommand{\formatimagefilename}[1]{%
  \lowercase{\StrSubstitute{#1}{ }{-}}%
}

% Update bird entry template with new image handling
\newcommand{\birdentry}[8]{%
  \index{#2@\textit{#2}}
  \begin{minipage}[t]{0.48\textwidth}
    \begin{mdframed}[
      ...
      \begin{center}
      \IfFileExists{../images/\formatimagefilename{#1}.jpg}
        {\includegraphics[width=0.95\textwidth,height=0.8\textheight,keepaspectratio]{../images/\formatimagefilename{#1}.jpg}}
        {\missingimage{#1}}
      \end{center}
    \end{mdframed}
  \end{minipage}\hfill
