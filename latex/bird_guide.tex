...
\birdentry{Red-naped Ibis}{\textit{Pseudibis papillosa}}
  ...
  {Breeds mainly during monsoon. Builds platform nest in large trees. Lays 2-4 pale bluish-white eggs.}
  {red-naped-ibis.jpg}

\birdentry{Peregrine Falcon}{\textit{Falco peregrinus}}
  {Kite-}
...
\birdentry{Asian Palm Swift}{\textit{Cypsiurus balasiensis}}
  {Sparrow-}
  {Common resident}
  {Smaller than House Swift, slender with deeply forked tail. Overall sooty brown appearance.}
  {Found around palm trees across campus.}
  {Very fast flier, rarely perches. Often seen around palm trees. Feeds exclusively on aerial insects.}
  {Breeds year-round. Attaches small nest to palm frond underside using saliva. Lays 2-3 white eggs.}
...
\birdentry{Common Kingfisher}{\textit{Alcedo atthis}}
  {Bulbul-}
  {Common resident}
  {Small kingfisher with brilliant blue upperparts and orange underparts. Long bill and short tail.}
  {Found near water bodies and ponds on campus.}
  {Perches low over water, dives vertically for fish. Often bobs head before striking.}
  {Breeds February to April. Nests in tunnel in earth bank. Lays 5-7 white eggs.}
